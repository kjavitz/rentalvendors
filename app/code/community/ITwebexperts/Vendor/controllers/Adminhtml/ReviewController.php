<?php
class ITwebexperts_Vendor_Adminhtml_ReviewController extends Mage_Adminhtml_Controller_Action {
	...
	public function indexAction()
    {
        ...
        $this->loadLayout();
        $this->_setActiveMenu('vendor/reviews/review');

        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_review_main'));
    ...
    public function editAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_review_edit'));
