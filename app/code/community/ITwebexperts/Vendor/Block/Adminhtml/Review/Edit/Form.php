<?php
class ITwebexperts_Vendor_Block_Adminhtml_Review_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
	
	protected function _prepareForm()
    {
        $review = Mage::registry('review_data');
        $vendor = Mage::getModel('customer/customer')->load($review->getEntityPkValue());
        ...
        $fieldset->addField('vendor_name', 'note', array(
            ...
            'text'      => '<a href="' . $this->getUrl('*/customer/edit', array('id' => $vendor->getId())) . '" onclick="this.target=\'blank\'">' . $vendor->getVendorNickname() . '</a>'
        ));
        ...
        $fieldset->addField('detailed_rating', 'note', array(
            ...
            'text'      => '<div id="rating_detail">'
                           . $this->getLayout()->createBlock('vendor/adminhtml_review_rating_detailed')->toHtml()
                           . '</div>',
        ));
